// $Id: default_buttons_functions.js,v 1.14.2.1 2009/09/09 15:43:30 ufku Exp $
...
function eDefPreview(NoAutoP, selOnly) {
  ...
  if (P.style.display == 'none') {
    ...
    E.safeToPreview = E.safeToPreview || T.value.indexOf('<') == -1;
    if (!E.safeToPreview) {
      html = '<div class="warning">The preview is disabled due to previously inserted HTML code in the content. This aims to protect you from any potentially harmful code inserted by other editors or users. If you own the content, just preview an empty text to re-enable the preview.</div>';
    }
