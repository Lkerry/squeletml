...
<div id="explicationsAdminDeconnexion">
	...
	<div class="bDcorps afficher">
		...
		<ul>
			...
			<ul>
				<li><?php printf(T_("Le texte original de la même section de la <acronym lang=\"en\">RFC</acronym> 2616: <a href=\"%1\$s\" hreflang=\"en\" lang=\"en\">«Authentication Credentials and Idle Clients»</a>."), "http://www.w3.org/Protocols/rfc2616/rfc2616-sec15.html#sec15.6"); ?></li>
			</ul></li>
			<li><?php printf(T_("<a href=\"%1\$s\" hreflang=\"en\">Section «<span lang=\"en\">Frequently asked questions about basic auth</span>»</a> du document <em lang=\"en\">Authentication, Authorization, and Access Control</em> (documentation Apache)."), "http://httpd.apache.org/docs/1.3/howto/auth.html#basicfaq"); ?></li>
