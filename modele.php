...
<?php echo publicationsRecentes($racine, $urlRacine, LANGUE, 'galerie', "L'aperçu", 5, TRUE, $dureeCache, $galerieFluxRssAuteurEstAuteurParDefaut, $auteurParDefaut, $galerieLienOriginalTelecharger); ?>
