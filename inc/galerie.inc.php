...
else
{
	...
	foreach($galerie as $oeuvre)
	{
		$corpsGalerie .= afficheOeuvre($racine, $urlRacine, $racineImgSrc, $urlImgSrc, $galerie, $galerieNavigation, 'vignette', $compteurGalerie, 'aucun', $galerieHauteurVignette, $galerieTelechargeOrig);
		$compteurGalerie++;
	}
}
